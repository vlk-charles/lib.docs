...
- x86/x64 machine running any OS; 4 GiB RAM, SSD, quad-core (recommended),
...
Instead of editing compile.sh to set options, you can set them by supplying command line parameters to _compile.sh_. For example:
